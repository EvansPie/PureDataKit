...
Pod::Spec.new do |s|
  s.name             = 'PureDataKit'
  s.version          = '0.1.0'
  s.summary          = 'A short description of PureDataKit.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Evangelos Pittas/PureDataKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Evangelos Pittas' => 'evangelospittas@gmail.com' }
  s.source           = { :git => 'https://github.com/Evangelos Pittas/PureDataKit.git', :tag => s.version.to_s }
